<%@ Page Title="Add news" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddNewsDoniyorJN.aspx.cs" Inherits="Rentoolo.DoniyorJN.AddNewsDoniyorJN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="elementsTable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="NewsText" CssClass="newsTextEditor" Width="500px" ClientIDMode="Static" TextMode="MultiLine" Rows="25" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:CheckBox ID="CheckBoxActive" Checked="true" runat="server" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
